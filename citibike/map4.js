  ...
  map4.addLayer(
    {
      ...
      source: {
        type: "geojson",
        data: "https://raw.githubusercontent.com/ilenapeng/points-unknown-data/main/citibike-data/citibikeData_09_21_ends.geojson",
      },
      paint: {
        'circle-radius': 3,
        // "circle-color": '#26547C',
...
// Create the popup
map4.on('click', 'map_points', function (e) {
...
map4.on('mouseenter', 'map_points', function () {
  map4.getCanvas().style.cursor = 'pointer';
});
map4.on('mouseleave', 'map_points', function () {
